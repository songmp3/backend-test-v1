...
## 보강 내용
"하드코드 수수료" 제거 후, partner_fee_policy 테이블 기반의 시점별 수수료 정책 적용을 구현했습니다.
커서 기반 페이지네이션 및 통계 집계를 포함한 결제 내역 조회 API(GET /api/v1/payments)를 완성했습니다.
외부 Test PG와의 연동을 RestTemplate과 암호화 로직을 통해 구현했습니다.
